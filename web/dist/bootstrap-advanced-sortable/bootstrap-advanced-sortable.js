    ...
    BootstrapTable.prototype.initHeader = function () {
        if (this.options.advancedSortable) {
            ...
            if(sort_btn_toolbar === "" && search_btn_toolbar === ""){
                that.$advancedSortable.html("<div class='sort-toolbar'>排序条件 ： <span class='sort-btn-toolbar'></span></div>" +
                    "<div class='search-toolbar'>筛选条件 ：  <span class='search-btn-toolbar'></span></div>");
            }
            ...
            this.$container.off('click', '.sort-btn').on('click', '.sort-btn', function (event) {
                if (that.options.sortable) {
                    ...
                    if (sort_model.length === 0) {
                        ...
                        let search = that.searchText !== undefined && that.searchText !== "" ? JSON.parse(that.searchText) : {};
                        let _searchText =  search[field] !== undefined && search[field] !==""  ? search[field].data : "";
